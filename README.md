## Hackathon auto-mode prototype

Командная ветка экспериментального auto mode: [результаты, наш diff и задачи команде](RESULTS.md), [запуск и настройки](HACKATHON.md). Это исследовательский прототип, не готовый защитный продукт. Данные живых прогонов коллеги отделены от проверок текущего кода.
